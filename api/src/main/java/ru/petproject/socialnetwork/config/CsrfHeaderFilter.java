...
import static ru.petproject.socialnetwork.config.Constants.XSRF_TOKEN_COOKIE_NAME;
import static ru.petproject.socialnetwork.config.Constants.XSRF_TOKEN_HEADER_NAME;
